...
"""
This one"s my approach to the "Re-requesting a Vanity Plate" problem
updated a version of "plates" for this one
"""
...
def test_numbers():
    ...
    assert is_valid("AB23EF") == True
    assert is_valid("ABC23F") == True
